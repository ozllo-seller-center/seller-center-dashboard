          ...
          <Stack spacing={4}>
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <List>
                    ...
                    <ListItem>
                      - Imagem não podem ser fotos no espelho (selfies no
                      espelho)
                    </ListItem>
                  </List>
                  ...
                  <p>
                    O restante das fotos precisa ser mostrando detalhes do
                    produto e é importante ter referência de tamanho. Para
                    produtos de moda, é interessante adicionar a tabela de
                    medidas na última foto, caso exista.
                  </p>
                  <p>
                    Para produtos de beleza e alimentos, é interessante
                    adicionar a tabela nutricional. Lembre-se que o consumidor
                    está comprando a foto. Ou seja, capriche na foto e tente
                    colocar o maior número de fotos possível.
                  </p>
                  <p>
                    Observação 1: Nossa plataforma recorta automaticamente para
                    que todas as imagens fiquem no formato de 1000x1000. Veja se
                    o recorte ficou coerente. Caso tenha cortado o seu produto,
                    cadastre uma foto 1000x1000.
                  </p>
                  <p>
                    Observação 2: Nossa plataforma reconfigura para que a imagem
                    tenha 1MG, tamanho exigido pelos marketplaces. Veja se, após
                    a reconfiguração, a imagem se mantém em boa qualidade.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <p>
                    Lembrando que mais de 60% dos consumidores pesquisam
                    palavras chaves nos marketplaces, então adicione as
                    principais características no título para que aumente a
                    chance do seu produto ser encontrado.
                  </p>
                  <p>Exemplo:</p>
                  <p>
                    Se o seu produto chama “Blusa Victoria” um exemplo de
                    cadastro seria “Blusa Victoria algodão estampado amarelo XYZ
                    Brand”. Se o seu produto chama “Blush rosa” um exemplo de
                    cadastro seria “Blush rosa bastão vegano XYZ Brand”
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    A descrição precisa ter todos os elementos necessários para
                    o consumidor. Recomendamos as seguintes informações:
                  </p>
                  <p>
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    ...
                    digitos. Caso você tenha, preencha-o na plataforma. Caso
                    você não tenha, pode deixar em branco
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    ...
                    identifca-lo. O campo de SKU na plataforma é referente ao
                    SKU pai do seu produto. É um campo obrigatório. Caso você
                    não tenha, é necessário criar.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    ...
                    calculo do frete. Insira o tamanho da embalagem do seu
                    produto e o peso estimado. Lembrando que as medidas são em
                    CM e o peso é em GRAMAS.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
            ...
            <Box>
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <p>
                    Se você quiser mais detalhes de como cadastrar cada campo,
                    em nosso FAQ {'"'}Como fazer seu catálogo da forma correta
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <p>
                    ...
                    não será possível cadastrar seus produtos. Também irá dar
                    erro caso você altere alguma informação das 2 primeiras
                    linhas da planilha.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    Exportar {'>'} Importar Planilha. Seus produtos estarão na
                    Aba de Produtos {'>'} Meus Produtos.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    Caso você queira alterar seus produtos, é possivel faze-los
                    de forma massiva via excel. Vá em Produtos {'>'} Meus
                    produtos {'>'} Selecione os produtos que você queira
                    exportar para editar {'>'} Ações em Massa {'>'} Exportar
                    Produtos {'>'} Aplicar
                  </p>
                  <p>
                  ...
                  <p>
                    Em segundos suas atualizações estarão disponíveis na pagina
                    de produtos.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    Caso você tenha algum ERP/Ecommerce que possuímos
                    integração, recomendo fazer a integração de seus produtos
                    para que você tenha todo o processo automatizado.
                  </p>
                  ...
                  <p>
                    ...
                    Etiqueta de Despacho na nossa plataforma, assim que tiver
                    uma venda, receberemos sua Nota Fiscal e Etiqueta de
                    Despacho.
                  </p>
                  <p>
                    Para começar a integração, vá em Integrações {'>'} escolha
                    sua plataforma e coloque os dados.
                  </p>
                  <p>
                    Caso você tenha dúvidas de como conseguir os dados
                    requeridos, aperte no botão de {'"'}
                    Dúvidas?{'"'} no canto direito que você terá o passo a
                    passo.
                  </p>
                  <p>
            ...
            <Box>
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    ...
                    plataforma, eles são enviados automaticamente para cada
                    canal e o prazo de Go Live depende de cada canal.
                  </p>
                  <p>
                    Magazine Luiza e B2W: Até 2 dias uteis Mercado Livre e
                    Shopee: Até 7 dias uteis CEA, Dafiti, Zattini, Netshoes,
                    Drogasil, Carrefour e GPA: até 15 dias uteis.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <p>
                    No seu pedido, aperte {'"'}ver detalhes{'"'} para ver todo
                  ...
                  <p>
                    3. Emita e Etiqueta de Despacho e insira na nossa
                    plataforma:
                  </p>
                  <p>
                  ...
                  <p>
                    Informação relevante: vendas da B2W, Mercado Livre e Shopee
                    o uso da Etiqueta de Despacho que eles fornecem é
                    obrigatório e estará disponível na Aba
                    {'"'}Aguardando Despacho{'"'} após a emissão da Nota Fiscal.
                  </p>
                  <p>
                    Assim que feito esses passos, o processo da venda é
                    concluída e o cliente final será atualizado. O prazo para
                    esse passo é de 48hrs uteis após a venda.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    Você pode enviar uma carta de agradecimento pela compra
                    porém é PROIBIDO enviar brindes, cupons de desconto que
                    direcionam ao seu site ou seu telefone na embalagem.
                  </p>
                  <p>
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    ...
                    seguinte. Vendas entre os dias 25 ao 10 são repassadas dia
                    30.
                  </p>
                </AccordionDetails>
              </Accordion>
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  <p>
                    Semanalmente disponibilizamos as campanhas da semana em
                    nossa plataforma. Vá em Menu {'>'} Campanhas e selecione as
              ...
              <Accordion>
                ...
                <AccordionDetails className={styles.accordionDetails}>
                  ...
                  <p>
                    ...
                    plataforma e independe do fluxo de uso ou de vendas. Você
                    pode alterar seu plano a qualquer momento, basta chamar o
                    nosso Suporte. para te auxiliarem com a mudança de plano.
                  </p>
                </AccordionDetails>
              </Accordion>
            </Box>
            ...
            >
              <p>Ainda com dúvidas? Entre em contato conosco: </p>
              <Button
                variant="contained"
                color="primary"
                href="https://api.whatsapp.com/send/?phone=5511994835353"
                target="_blank"
                sx={{ mt: '1rem' }}
              >
                <FaWhatsapp
